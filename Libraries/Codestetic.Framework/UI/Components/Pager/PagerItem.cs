...
namespace Codestetic.Web.Framework.UI
{
    ...
    public class PagerItem
    {
        ...
        public PagerItem(string text) : this(text, String.Empty, PagerItemType.Page, PagerItemState.Normal) { }

        public PagerItem(string text, string url) : this(text, url, PagerItemType.Page, PagerItemState.Normal) { }

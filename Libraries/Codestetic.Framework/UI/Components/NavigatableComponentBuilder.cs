...
namespace Codestetic.Web.Framework.UI
{
        ...
        where TBuilder : ComponentBuilder<TComponent, TBuilder>
    {
        ...
        public NavigatableComponentBuilder(TComponent component, HtmlHelper htmlHelper) : base(component, htmlHelper) { }
    ...
    public abstract class NavigatableComponentWithContentBuilder<TComponent, TBuilder> : NavigatableComponentBuilder<TComponent, TBuilder>
        ...
        where TBuilder : ComponentBuilder<TComponent, TBuilder>
    {
        public NavigatableComponentWithContentBuilder(TComponent component, HtmlHelper htmlHelper) : base(component, htmlHelper) { }

    ...
    public static class Extensions
    {
            ...
            bool convertToUserTime, string defaultFormat)
        {
            ...
            else
            {
                ...
                {
                    tmp1 = EngineContext.Current.Resolve<IDateTimeHelper>().ConvertToUserTime(tmp1, DateTimeKind.Utc).Value;
                }
                //default formatting
        ...
        public static ButtonBuilder LocalIcon(this ButtonBuilder button, string icon)
        {
            var buttonHtml = button.ToHtmlString();
            return null;
        }
    }
}

...
namespace Codestetic.Web.Services.Media
{
    ...
    public interface IImageCache
    {
        ...
        CachedImageResult GetCachedImage(long? pictureId, string seoFileName, string extension, object settings = null);
        ...
        #region Markers
        void DeleteCachedMarkers();
        void DeleteCachedMarker(Marker icon);
        #endregion Markers
    }
}

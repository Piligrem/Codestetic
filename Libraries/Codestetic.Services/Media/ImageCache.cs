...
namespace Codestetic.Web.Services.Media
{
    ...
    public class ImageCache : IImageCache
    {
        ...
        public virtual CachedImageResult GetCachedImage(long? pictureId, string seoFileName, string extension, object settings = null)
        {
        ...
        public virtual string GetImageUrl(string imagePath)
        {
            if (imagePath.IsEmpty())
                return null;

            var url = /*_webHelper.GetSiteLocation() + */ "/Media/Thumbs/";
        ...
        #region Markers
        public virtual void DeleteCachedMarkers()
        {
            for (int i = 0; i < 10; i++)
            {
                try
        ...
        public virtual void DeleteCachedMarker(Marker icon)
        {
            string filter = string.Format("{0}*.*", icon.Id.ToString("0000000"));
        ...
        /// <summary>
        /// Returns the file name with the subfolder (when multi dirs are enabled)
        /// </summary>
        /// <param name="picture"></param>
        /// <param name="settings"></param>
        /// <returns></returns>
        internal string GetCachedImagePath(long? pictureId, string seoFileName, string extension, ResizeSettings settings = null)
        {

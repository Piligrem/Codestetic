...
namespace Codestetic.Web.Services.Localization
{
    public partial interface ILocalizationService
    {
        ...
        /// <returns>Locale string resource</returns>
        LocaleStringResource GetLocaleStringResourceByName(string resourceName, long languageId, bool logIfNotFound = true);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Locale string resources</returns>
        IDictionary<string, Tuple<long, string>> GetResourceValues(long languageId, bool forceAll = false);
        ...
        /// <returns>A string representing the requested resource string.</returns>
        string GetResource(string resourceKey, long languageId = 0, bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false);

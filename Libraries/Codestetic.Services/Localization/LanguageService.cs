...
namespace Codestetic.Web.Services.Localization
{
    ...
    {
        #region Constants
        private const string LANGUAGES_ALL_KEY = "specter.language.all-{0}";
        private const string LANGUAGES_COUNT = "specter.language.count-{0}";
        private const string LANGUAGES_BY_CULTURE_KEY = "specter.language.culture-{0}";
        private const string LANGUAGES_BY_SEOCODE_KEY = "specter.language.seocode-{0}";
        private const string LANGUAGES_PATTERN_KEY = "specter.language.";
        private const string LANGUAGES_BY_ID_KEY = "specter.language.id-{0}";
        #endregion Constants

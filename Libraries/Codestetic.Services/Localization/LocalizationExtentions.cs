...
namespace Codestetic.Web.Services.Localization
{
    public static class LocalizationExtentions
    {
        ...
        public static string GetLocalizedValues<T>(this T value, ILocalizationService localizationService, IWorkContext workContext, string field)
        {
            if (workContext == null)
                throw new ArgumentNullException("workContext");

            return GetLocalizedValues<T>(value, localizationService, workContext.WorkingLanguage.Id, field);
        }

        public static string GetLocalizedValues<T>(this T value, ILocalizationService localizationService, IWorkContext workContext)
        {
            if (workContext == null)
                throw new ArgumentNullException("workContext");

            return GetLocalizedValues<T>(value, localizationService, workContext.WorkingLanguage.Id);
        }

        public static string GetLocalizedValues<T>(this T value, ILocalizationService localizationService, long languageId = 0, string field = null)
        {
            if (localizationService == null)
                throw new ArgumentNullException("localizationService");

            var valueForLocalize = value.ToString();
            if (field.HasValue())
                valueForLocalize = value.GetType().GetProperty(field).GetValue(value).ToString();

            //localized value
            var resourceName = typeof(T).ToString();
            resourceName = string.Format("Values.{0}.{1}", resourceName.Substring(resourceName.LastIndexOf(".") + 1), valueForLocalize);
            string result = localizationService.GetResource(resourceName, languageId, false, "", true);

            //set default value if required
            if (String.IsNullOrEmpty(result))
                result = Inflector.Titleize(valueForLocalize);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Localized value</returns>
        public static string GetLocalizedEnum<T>(this T enumValue, ILocalizationService localizationService, long languageId = 0)
            where T : struct
        {
            if (localizationService == null)
                throw new ArgumentNullException("localizationService");
            ...
            var resourceName = typeof(T).ToString();
            //localized value
            resourceName = string.Format("Enums.{0}.{1}", resourceName.Substring(resourceName.LastIndexOf(".") + 1), enumValue.ToString());
            string result = localizationService.GetResource(resourceName, languageId, false, "", true);
        ...
        public static void AddPluginLocaleResource(this BasePlugin plugin, ILocalizationService localizationService, string resourceName, string value, long languageID)
        {
            if (languageID != 0)
            {
        ...
        /// <param name="returnDefaultValue">A value indicating whether to return default value (if localized is not found)</param>
        /// <returns>Localized value</returns>
        public static string GetLocalizedValue<T>(this T plugin, ILocalizationService localizationService, string propertyName, long languageId = 0, bool returnDefaultValue = true)
            where T : IPlugin
        {
            if (plugin == null)
                throw new ArgumentNullException("plugin");
        ...
        /// <param name="returnDefaultValue">A value indicating whether to return default value (if localized is not found)</param>
        /// <returns>Localized value</returns>
        public static string GetLocalizedValue(this PluginDescriptor descriptor, ILocalizationService localizationService, string propertyName, long languageId = 0, bool returnDefaultValue = true)
        {
            if (localizationService == null)
                throw new ArgumentNullException("localizationService");
        ...
        public static void SaveLocalizedValue<T>(this T plugin, ILocalizationService localizationService, long languageId,
        ...
        /// <param name="propertyName">Name of the property</param>
        /// <param name="value">Localized value</param>
        public static void SaveLocalizedValue(this PluginDescriptor descriptor, ILocalizationService localizationService, long languageId,

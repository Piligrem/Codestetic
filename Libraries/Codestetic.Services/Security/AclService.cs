...
namespace Codestetic.Web.Services.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        private const string ACLRECORD_BY_ENTITYID_NAME_KEY = "specter.aclrecord.entityid-name-{0}-{1}";
        private const string ACLRECORD_PATTERN_KEY = "specter.aclrecord.";
        ...
        public virtual AclRecord GetAclRecordById(long aclRecordId)
        {
            if (aclRecordId == 0)
                return null;
		...
		public virtual IList<AclRecord> GetAclRecordsFor(string entityName, long entityId)
		{
        ...
        public virtual void InsertAclRecord<T>(T entity, long userRoleId) where T : BaseEntity, IAclSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");
        ...
        public virtual long[] GetUserRoleIdsWithAccess<T>(T entity) where T : BaseEntity, IAclSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");

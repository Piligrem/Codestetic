...
namespace Codestetic.Web.Services.Seo
{
    ...
    public partial interface  IUrlRecordService
    {
        ...
        UrlRecord GetUrlRecordById(long urlRecordId);
        ...
        string GetActiveSlug(long entityId, string entityName, long languageId);
        ...
        void SaveSlug<T>(T entity, string slug, long languageId) where T : BaseEntity, ISlugSupported;
    }
}
...
namespace Codestetic.Web.Services.Seo
{
    /// <summary>
    ...
    {
        #region Constants
        private const string URLRECORD_ACTIVE_BY_ID_NAME_LANGUAGE_KEY = "specter.urlrecord.active.id-name-language-{0}-{1}-{2}";
        private const string URLRECORD_PATTERN_KEY = "specter.urlrecord.";
        #endregion Constants
        ...
        public virtual UrlRecord GetUrlRecordById(long urlRecordId)
        {
            if (urlRecordId == 0)
                return null;
        ...
        public virtual string GetActiveSlug(long entityId, string entityName, long languageId)
        {   
        ...
        public virtual void SaveSlug<T>(T entity, string slug, long languageId) where T : BaseEntity, ISlugSupported
        {
            if (entity == null)

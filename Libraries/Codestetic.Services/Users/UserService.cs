...
namespace Codestetic.Web.Services.Users
{
    public partial class UserService : IUserService
    {
        ...
        private const string USERROLES_BY_SYSTEMNAME_KEY = "specter.userrole.systemname-{0}";
        ...
        public virtual IPagedList<User> GetAllUsers(DateTime? registrationFrom,
            DateTime? registrationTo, long[] userRoleIds, string email, string username,
        ...
        /// <param name="pageSize">Page size</param>
        /// <returns>User collection</returns>
        public virtual IPagedList<User> GetOnlineUsers(DateTime lastActivityFromUtc, long[] userRoleIds, 
            int pageIndex, int pageSize)
        {
            var query = _userRepository.Table;
        ...
        public virtual void DeleteUser(User user)
        {
            ...
            if (user.IsSystemAccount)
                throw new SpecterException(string.Format("System user account ({0}) could not be deleted", user.SystemName));
        ...
        public virtual User InsertGuestUser()
        {
            ...
            if (guestRole == null)
                throw new SpecterException("'Guests' role could not be loaded");
        ...
        public virtual void DeleteUserRole(UserRole userRole)
        {
            ...
            if (userRole.IsSystemRole)
                throw new SpecterException("System role could not be deleted");
        ...
        public virtual UserRole GetUserRoleById(long userRoleId)
        {
            if (userRoleId == 0)
                return null;

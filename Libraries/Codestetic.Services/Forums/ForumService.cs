...
namespace Codestetic.Web.Services.Forums
{
    ...
    {
        #region Constants
        private const string FORUMGROUP_ALL_KEY = "specter.forumgroup.all";
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "specter.forum.allbyforumgroupid-{0}";
        private const string FORUMGROUP_PATTERN_KEY = "specter.forumgroup.";
        private const string FORUM_PATTERN_KEY = "specter.forum.";
        #endregion
        ...
        private void UpdateForumStats(long forumId)
        {
            if (forumId == 0)
            {
                return;
        ...
        private void UpdateForumTopicStats(long forumTopicId)
        {
            if (forumTopicId == 0)
            {
                return;
        ...
        public virtual ForumGroup GetForumGroupById(long forumGroupId)
        {
            if (forumGroupId == 0)
                return null;
        ...
        public virtual Forum GetForumById(long forumId)
        {
            if (forumId == 0)
                return null;
        ...
        public virtual IList<Forum> GetAllForumsByGroupId(long forumGroupId)
        {
        ...
        public virtual ForumTopic GetTopicById(long forumTopicId)
        {
        ...
        /// <returns>Forum Topic</returns>
        public virtual ForumTopic GetTopicById(long forumTopicId, bool increaseViews)
        {
            if (forumTopicId == 0)
            {
                return null;
        ...
        public virtual IPagedList<ForumTopic> GetAllTopics(long forumId,
        ...
        /// <returns>Forum Topics</returns>
        public virtual IList<ForumTopic> GetActiveTopics(long forumId, int count)
        {
            var query1 = from ft in _forumTopicRepository.Table
                         where
                         (forumId == 0 || ft.ForumId == forumId) &&
        ...
        public virtual ForumTopic MoveTopic(long forumTopicId, long newForumId)
        {
            var forumTopic = GetTopicById(forumTopicId);
            if (forumTopic == null)
                return forumTopic;
        ...
        public virtual ForumPost GetPostById(long forumPostId)
        {
            if (forumPostId == 0)
            {
                return null;
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(long forumTopicId, long userId, string keywords, int pageIndex, int pageSize)
        {
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(long forumTopicId, long userId, string keywords, bool ascSort, int pageIndex, int pageSize)
        {
        ...
        public virtual PrivateMessage GetPrivateMessageById(long privateMessageId)
        {
        ...
        public virtual IPagedList<PrivateMessage> GetAllPrivateMessages(long fromUserId,
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (userTo == null)
            {
                throw new SpecterException("Recipient could not be loaded");
            }
        ...
        public virtual ForumSubscription GetSubscriptionById(long forumSubscriptionId)
        {
        ...
        public virtual IPagedList<ForumSubscription> GetAllSubscriptions(long userId, long forumId,
        ...
        public virtual int CalculateTopicPageIndex(long forumTopicId, int pageSize, long postId)
        {
            int pageIndex = 0;

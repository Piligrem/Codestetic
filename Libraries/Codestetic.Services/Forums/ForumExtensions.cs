...
using Codestetic.Web.Core.Html;
...
namespace Codestetic.Web.Services.Forums
{
    public static class ForumExtensions
    {
        ...
        public static string FormatForumSignatureText(this string text)
        {
            ...
            text = Codestetic.Web.Core.Html.HtmlUtils.FormatText(text, false, true, false, false, false, false);
            return text;
        }
        ...
        public static string FormatPrivateMessageText(this PrivateMessage pm)
        {
            ...
            text = Codestetic.Web.Core.Html.HtmlUtils.FormatText(text, false, true, false, true, false, false);

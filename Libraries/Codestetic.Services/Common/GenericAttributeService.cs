...
namespace Codestetic.Web.Services.Common
{
    ...
    {
        #region Constants
        private const string GENERICATTRIBUTE_KEY = "specter.genericattribute.{0}-{1}";
        private const string GENERICATTRIBUTE_PATTERN_KEY = "specter.genericattribute.";
        #endregion Constants
        ...
        /// <param name="storeId">Site identifier; pass 0 if this attribute will be available for all stores</param>

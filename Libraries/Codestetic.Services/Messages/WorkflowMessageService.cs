...
namespace Codestetic.Web.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        #region Utilities
        protected long SendNotification(
            MessageTemplate messageTemplate, EmailAccount emailAccount, 
			long languageId, IEnumerable<Token> tokens,
        ...
        protected MessageTemplate GetLocalizedActiveMessageTemplate(string messageTemplateName, long languageId)
        {
        ...
        protected EmailAccount GetEmailAccountOfMessageTemplate(MessageTemplate messageTemplate, long languageId)
        {
		...
		protected long EnsureLanguageIsActive(long languageId)
        {
        ...
        public virtual long SendUserRegisteredNotificationMessage(User user, long languageId)
        {
            if (user == null)
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual long SendUserWelcomeMessage(User user, long languageId)
        {
            if (user == null)
                throw new ArgumentNullException("user");
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual long SendUserEmailValidationMessage(User user, long languageId)
        {
            if (user == null)
                throw new ArgumentNullException("user");
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual long SendUserPasswordRecoveryMessage(User user, long languageId)
        {
            if (user == null)
                throw new ArgumentNullException("user");
        ...
        /// <returns>Queued email identifier</returns>
        public virtual long SendNewsLetterSubscriptionActivationMessage(NewsLetterSubscription subscription, long languageId)
        {
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual long SendNewsLetterSubscriptionDeactivationMessage(NewsLetterSubscription subscription, long languageId)
        {
            if (subscription == null)
                throw new ArgumentNullException("subscription");
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public long SendNewForumTopicMessage(User user, ForumTopic forumTopic, Forum forum, long languageId)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public long SendNewForumPostMessage(User user, ForumPost forumPost, ForumTopic forumTopic,
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public long SendPrivateMessageNotification(PrivateMessage privateMessage, long languageId)
        {
        ...
        #region Misc
        public virtual long SendGenericMessage(string messageTemplateName, Action<GenericMessageContext> cfg)
        {

    ...
    public partial class EmailAccountService:IEmailAccountService
    {
        ...
        public virtual void DeleteEmailAccount(EmailAccount emailAccount)
        {
            ...
            if (GetAllEmailAccounts().Count == 1)
                throw new SpecterException("You cannot delete this email account. At least one account is required.");
        ...
        public virtual EmailAccount GetEmailAccountById(long emailAccountId)
        {
            if (emailAccountId == 0)
                return null;

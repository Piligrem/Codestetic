...
namespace Codestetic.Web.Services.Messages
{
    public partial class MessageTemplateService: IMessageTemplateService
    {
        ...
        private const string MESSAGETEMPLATES_ALL_KEY = "specter.messagetemplate.all";
        private const string MESSAGETEMPLATES_BY_NAME_KEY = "specter.messagetemplate.name-{0}";
        private const string MESSAGETEMPLATES_PATTERN_KEY = "specter.messagetemplate.";
        ...
        public virtual MessageTemplate GetMessageTemplateById(long messageTemplateId)
        {

...
using Codestetic.Web.Services.Extensions;
...
namespace Codestetic.Web.Services.SignalR
{
    ...
    public class NotificationHub : Hub
    {
        ...
        public string GetMarker(long iconId)
        {
        ...
        public static void SendNotifyToUser(long userId, object position)
        {
        ...
        public static void SendPositionToUser(long userId, object position)
        {
        ...
        public static void SendIndicatorToUser(long userId, object indicator)
        {

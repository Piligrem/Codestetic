...
namespace Codestetic.Web.Data.Setup
{
	...
	{
		private readonly SpecterObjectContext _ctx;
		private readonly DbSet<Language> _languages;
		private readonly DbSet<LocaleStringResource> _resources;
		
		public LocaleResourcesMigrator(SpecterObjectContext ctx)
		{
		...
		private LocaleStringResource GetResource(string key, long langId, IList<LocaleStringResource> local, out bool isLocal)
		{

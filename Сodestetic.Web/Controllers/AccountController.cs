...
//        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
                ...
                if (_userRegistrationService.ValidateUser(_userSettings.UsernamesEnabled ? model.Username : model.Email, model.Password))
                {
                    ...
                    else
                    {
                        ...
                        if (!model.IsAdmin)
                            ...
                            return RedirectToAction("Index", "Dashboard", new { area = "Admin" }); // "Admin_default");
        ...
        public ActionResult LogOff()
        {
            //standard logout 
            //activity log
            _userActivityService.InsertActivity("Logout", _localizationService.GetResource("ActivityLog.Logout"));
            _userActivityService.InsertActivity("Logout", "Logout");
        ...
        //    _authenticationService.SignOut();
        //    var url = string.Join("/", RedirectToAction("Index", "Home", new { area = "" }).RouteValues.Values.Reverse().ToArray());
        //    return Json(new { Success = "true", Redirect = "/" }, JsonRequestBehavior.DenyGet);
        //}
        ...
        //{
        //    var linkedAccounts = new List<UserLoginInfo>() { default(UserLoginInfo) }; // UserManager.GetLogins(User.Identity.GetUserId());

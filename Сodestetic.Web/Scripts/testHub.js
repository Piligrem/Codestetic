...
$(function () {
    ...
    connection.stateChanged(function (state) {
        ...
        var buttonMarker = $("#startStopMarker");
        var buttonText = $("#startStopText");
        if (printState(state.newState) == "connected") {
            buttonMarker.removeClass("glyphicon glyphicon-play");
            buttonMarker.addClass("glyphicon glyphicon-stop");
            buttonText.text("Stop Connection");
        } else if (printState(state.newState) == "disconnected") {
            buttonMarker.removeClass("glyphicon glyphicon-stop");
            buttonMarker.addClass("glyphicon glyphicon-play");

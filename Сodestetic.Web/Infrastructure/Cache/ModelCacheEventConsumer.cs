...
namespace Codestetic.Web.Infrastructure.Cache
{
    /// <summary>
    ...
    #endregion SpecificationAttribute
    ...
    #endregion SpecificationAttributeOption
    ...
    #endregion ProductSpecificationAttribute
    #region Topic
    ...
    #endregion ManufacturerTemplate
    ...
    #endregion UserRole
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string MANUFACTURER_NAVIGATION_MODEL_KEY = "specter.pres.manufacturer.navigation-{0}-{1}-{2}";
        public const string MANUFACTURER_NAVIGATION_PATTERN_KEY = "specter.pres.manufacturer.navigation";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_KEY = "specter.pres.manufacturer.hasfeaturedproducts-{0}-{1}-{2}";
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "specter.pres.manufacturer.hasfeaturedproducts";
        ...
        /// {2} : current store id
        /// </remarks>
        public const string CATEGORY_NAVIGATION_MODEL_KEY = "specter.pres.category.navigation-{0}-{1}-{2}";
        public const string CATEGORY_NAVIGATION_PATTERN_KEY = "specter.pres.category.navigation";
        ...
        /// {3} : current store id
        /// </remarks>
        public const string CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY = "specter.pres.category.childidentifiers-{0}-{1}-{2}-{3}";
        public const string CATEGORY_CHILD_IDENTIFIERS_PATTERN_KEY = "specter.pres.category.childidentifiers";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_KEY = "specter.pres.category.hasfeaturedproducts-{0}-{1}-{2}";
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "specter.pres.category.hasfeaturedproducts";
        ...
        /// {3} : current store id
        /// </remarks>
        public const string PRODUCT_BREADCRUMB_MODEL_KEY = "specter.pres.product.breadcrumb-{0}-{1}-{2}-{3}";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY = "specter.pres.product.breadcrumb";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_BY_PRODUCT_MODEL_KEY = "specter.pres.producttag.byproduct-{0}-{1}-{2}";
        public const string PRODUCTTAG_BY_PRODUCT_PATTERN_KEY = "specter.pres.producttag.byproduct";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_POPULAR_MODEL_KEY = "specter.pres.producttag.popular-{0}-{1}";
        public const string PRODUCTTAG_POPULAR_PATTERN_KEY = "specter.pres.producttag.popular";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURERS_MODEL_KEY = "specter.pres.product.manufacturers-{0}-{1}-{2}";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY = "specter.pres.product.manufacturers";
        ...
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_SPECS_MODEL_KEY = "specter.pres.product.specs-{0}-{1}";
        public const string PRODUCT_SPECS_PATTERN_KEY = "specter.pres.product.specs";
        ...
        /// {2} : store id
        /// </remarks>
        public const string TOPIC_MODEL_KEY = "specter.pres.topic.details-{0}-{1}-{2}";
        public const string TOPIC_PATTERN_KEY = "specter.pres.topic.details";
        ...
        /// {1} : language id
        /// </remarks>
        public const string TOPIC_WIDGET_PATTERN_KEY = "specter.pres.topic.widget";
        public const string TOPIC_WIDGET_ALL_MODEL_KEY = "specter.pres.topic.widget-all-{0}-{1}";
        ...
        /// {2} : language id
        /// </remarks>
        public const string TOPIC_WIDGET_BYZONE_PATTERN_KEY = "specter.pres.topic.widget-byzone";
        public const string TOPIC_WIDGET_BYZONE_MODEL_KEY = "specter.pres.topic.widget-byzone-{0}-{1}-{2}";
        ...
        /// </remarks>
        public const string CATEGORY_TEMPLATE_MODEL_KEY = "specter.pres.categorytemplate-{0}";
        public const string CATEGORY_TEMPLATE_PATTERN_KEY = "specter.pres.categorytemplate";
        ...
        /// </remarks>
        public const string MANUFACTURER_TEMPLATE_MODEL_KEY = "specter.pres.manufacturertemplate-{0}";
        public const string MANUFACTURER_TEMPLATE_PATTERN_KEY = "specter.pres.manufacturertemplate";
        ...
        /// </remarks>
        public const string PRODUCT_TEMPLATE_MODEL_KEY = "specter.pres.producttemplate-{0}";
        public const string PRODUCT_TEMPLATE_PATTERN_KEY = "specter.pres.producttemplate";
        ...
        /// {0} : current store id
        /// </remarks>
        public const string HOMEPAGE_BESTSELLERS_IDS_KEY = "specter.pres.bestsellers.homepage-{0}";
        public const string HOMEPAGE_BESTSELLERS_IDS_PATTERN_KEY = "specter.pres.bestsellers.homepage";
        ...
        /// {1} : current store id
        /// </remarks>
        public const string PRODUCTS_ALSO_PURCHASED_IDS_KEY = "specter.pres.alsopuchased-{0}-{1}";
        public const string PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY = "specter.pres.alsopuchased";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DEFAULTPICTURE_MODEL_KEY = "specter.pres.product.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY = "specter.pres.product.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_PICTURE_MODEL_KEY = "specter.pres.category.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_PICTURE_PATTERN_KEY = "specter.pres.category.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string MANUFACTURER_PICTURE_MODEL_KEY = "specter.pres.manufacturer.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY = "specter.pres.manufacturer.picture";
        ...
        /// codehint: sm-edit
        /// </remarks>
        public const string CART_PICTURE_MODEL_KEY = "specter.pres.cart.picture-{0}-{1}-{2}-{3}-{4}-{5}-{6}";
        public const string CART_PICTURE_PATTERN_KEY = "specter.pres.cart.picture";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string HOMEPAGE_POLLS_MODEL_KEY = "specter.pres.poll.homepage-{0}";
        /// <summary>
        ...
        /// {1} : language ID
        /// </remarks>
        public const string POLL_BY_SYSTEMNAME__MODEL_KEY = "specter.pres.poll.systemname-{0}-{1}";
        public const string POLLS_PATTERN_KEY = "specter.pres.poll.";
        ...
        /// {1} : store ID
        /// </remarks>
        public const string BLOG_TAGS_MODEL_KEY = "specter.pres.blog.tags-{0}-{1}";
        /// <summary>
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_MONTHS_MODEL_KEY = "specter.pres.blog.months-{0}-{1}";
        public const string BLOG_PATTERN_KEY = "specter.pres.blog.";
        ...
        /// {1} : store ID
        /// </remarks>
        public const string HOMEPAGE_NEWSMODEL_KEY = "specter.pres.news.homepage-{0}-{1}";
        public const string NEWS_PATTERN_KEY = "specter.pres.news.";
        ...
        /// {2} : language ID
        /// </remarks>
        public const string STATEPROVINCES_BY_COUNTRY_MODEL_KEY = "specter.pres.stateprovinces.bycountry-{0}-{1}-{2}";
        public const string STATEPROVINCES_PATTERN_KEY = "specter.pres.stateprovinces.";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string AVAILABLE_LANGUAGES_MODEL_KEY = "specter.pres.languages.all-{0}";
        public const string AVAILABLE_LANGUAGES_PATTERN_KEY = "specter.pres.languages.";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string AVAILABLE_CURRENCIES_MODEL_KEY = "specter.pres.currencies.all-{0}-{1}";
        public const string AVAILABLE_CURRENCIES_PATTERN_KEY = "specter.pres.currencies.";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string SITEHEADER_MODEL_KEY = "specter.pres.siteheader-{0}";
        public const string SITEHEADER_MAP_MODEL_KEY = "specter.pres.siteheadermap-{0}";
        public const string SITEHEADER_MODEL_PATTERN_KEY = "specter.pres.siteheader";

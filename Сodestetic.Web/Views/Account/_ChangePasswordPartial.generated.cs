...
namespace ASP
{
    ...
    public partial class _Views_Account__ChangePasswordPartial_cshtml : Specter.Web.Framework.ViewEngines.Razor.WebViewPage<Specter.Web.Models.ManageUserViewModel>
    {
...
WriteLiteral("            ");
       ...
       Write(Html.PasswordFor(m => m.OldPassword, new { @class = "form-control", style = "width:initial;" }));
...
WriteLiteral("            ");
       ...
       Write(Html.PasswordFor(m => m.NewPassword, new { @class = "form-control", style = "width:initial;" }));
...
WriteLiteral("            ");
       ...
       Write(Html.PasswordFor(m => m.ConfirmPassword, new { @class = "form-control", style = "width:initial;" }));
...
WriteLiteral(" class=\"btn btn-default button-face\"");

...
namespace Codestetic.Core.Infrastructure
{
    ...
    public class EngineContext
    {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("SmartStoreConfig") as CodesteticConfig;
        ...
        public static IEngine CreateEngineInstance(CodesteticConfig config)
        {

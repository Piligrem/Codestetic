...
namespace Codestetic.Core.Domain.Employees
{
    public class EmployeeSettings : ISettings
    {
        ...
        /// </summary>
        public bool AllowEmployeesToUploadAvatars { get; set; }
        ...
        /// </summary>
        public bool ShowEmployeesLocation { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show customers join date
        /// </summary>
        public bool ShowEmployeesJoinDate { get; set; }
        ...
        /// </summary>
        public bool NotifyNewEmployeeRegistration { get; set; }
        ...
        /// </summary>
        public EmployeeNameFormat EmployeesNameFormat { get; set; }
